...
//#include <pthread.h>    // [ziquan] mutex
}
/**
...
typedef enum
{
    ...
    ARCODECS_FORMAT_UYVY422,    //[ziquan]
    ARCODECS_FORMAT_RGB24,    //[ziquan]
...
//    pthread_mutex_t lock;   // [ziquan] mutex
...
//ARCODECS_Manager_Frame2_t* ARCODECS_Manager_Decode (ARCODECS_Manager_t *manager, eARCODECS_ERROR *error);
